      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Welcome to our Online Book Store</h1>
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Explore our wide collection of books and find your next favorite read. To make your checkout process easy we have added pay with VISA and American Express</p>
          ...
          <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img src="https://pen.org/wp-content/uploads/2023/03/Martin-County-Banned-Books-Featured-Image-1.png" alt="mockup" />
          </div>
        </div>
      </section>
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Here is the Book Category. Choose What you like!</h2>
            <p className="text-gray-500 sm:text-xl dark:text-gray-400">There are different type of collection available to our store like Fantasy, Thriller, Biography, History, Islamic Book etc.</p>
          </div>
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Fiction</h3>
              <p className="text-gray-500 dark:text-gray-400">Imaginative narratives that transport readers to different worlds and explore the depths of human imagination.</p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Poetry</h3>
              <p className="text-gray-500 dark:text-gray-400">Evocative verses that convey emotions, thoughts, and experiences in a lyrical and expressive manner.</p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p className="text-gray-500 dark:text-gray-400">Immerse yourself in magical realms, mythical creatures, and epic adventures beyond imagination.</p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Thriller</h3>
              <p className="text-gray-500 dark:text-gray-400">Nerve-wracking narratives that keep you on the edge of your seat, filled with suspense and unexpected twists.</p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">History</h3>
              <p className="text-gray-500 dark:text-gray-400">Dive into the past, unravel significant events, and gain insights into civilizations that shaped our world.</p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p className="text-gray-500 dark:text-gray-400">Bone-chilling tales that evoke fear, featuring supernatural phenomena and psychological suspense.</p>
            </div>
          </div>
        </div>
      </section>
